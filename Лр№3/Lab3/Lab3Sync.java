...
public class Lab3Sync {
    ...
    // Общий объект блокировки для синхронизации доступа к счетчику
    ...
    // Класс задачи, инкрементирующей счетчик с использованием synchronized
    ...
    // Класс задачи, декрементирующей счетчик с использованием synchronized
